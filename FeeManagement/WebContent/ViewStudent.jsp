...
<div class="design1">
	...
	<table border="1">
		...
		<tr>
			...
			<td><a
				href="updateStudentForm?requestAction=updateFormStudent&studRoll=<%=student.getStudRoll() %>">Edit</a>
			</td>
			<td><a
				href="deleteStudent?requestAction=deleteStudent&studRoll=<%=student.getStudRoll() %>">Delete</a>
			</td>
			<% } 
		%>
		</tr>
