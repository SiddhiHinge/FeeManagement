<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.project.Beans.*"%>
...
<h2>Edit Accountant Form</h2>
	<form action="editAccountant">
		...
		<table>
			...
			<tr>
			<td>Password:</td>
			<td><input type="password" name="accPassword" value="<%=accountant.getAccPassword()%>" readonly="readonly"/></td>
			</tr>
			
			<tr>
			<td>Contact Number:</td>
			<td><input type="text" name="accContact" value="<%=accountant.getAccContact()%>" /></td>
			</tr>

		</table>
		<input type="submit" class="myButton" value="Edit Accountant" /><br><br>
	</form>
